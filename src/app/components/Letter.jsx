...
export default function Letter() {
    ...
    const letterText = `Happiest Birthday to mera Laddoo,
...
Today’s all about you — so I hope you’re ready to be spoiled, loved, hugged, kissed (a lot), and celebrated like you deserve. You’ve got the biggest piece of my heart, and I’m so proud to call you mine.
So here’s to you, my love—today and always.
